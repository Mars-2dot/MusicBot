 ...
 */
package com.mars.MusicBot.utils;
...
public class OtherUtil
{
    public final static String NEW_VERSION_AVAILABLE = "There is a new version of JMusicBot available!\n"
                    + "Current version: %s\n"
                    + "New Version: %s\n\n"
                    + "Please visit https://github.com/Mars-2dot/MusicBot/releases/latest to get the latest release.";
    ...
    public static String getLatestVersion()
    {
        try
        {
            Response response = new OkHttpClient.Builder().build()
                    .newCall(new Request.Builder().get().url("https://api.github.com/repos/Mars-2dot/MusicBot/releases/latest").build())
                    .execute();
